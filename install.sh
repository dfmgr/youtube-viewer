...
# @@File             :  install.sh
# @@Description      :  Install configurations for youtube-viewer
...
GLOBAL_OS_PACKAGES="youtube-viewer "
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__run_post_install() {
  local getRunStatus=0
  __replace_all "replacehome" "$HOME" "$APPDIR"
  return $getRunStatus
}
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
